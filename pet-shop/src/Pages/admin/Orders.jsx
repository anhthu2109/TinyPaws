            ...
            {orderToDelete && (
                <div className="fixed inset-0 z-[100000] flex items-center justify-center bg-black/50 px-4">
                    <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
                        <h3 className="text-lg font-semibold text-center text-gray-900">Xác nhận xóa đơn hàng</h3>
                        <p className="mt-3 text-sm text-gray-600">
                            Bạn chắc chắn muốn xóa đơn hàng này. Hành động này không thể hoàn tác.
                            {/* <span className="font-semibold text-gray-900"> "{orderToDelete.order_number}"</span>? Hành động này không thể hoàn tác. */}
                        </p>
