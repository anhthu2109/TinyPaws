...
const AddBlog = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Tạm thời cho phép không có ảnh (sẽ dùng ảnh mặc định)
      ...
      const blogData = {
        ...
        featured_image: form.featured_image || 'https://images.unsplash.com/photo-1450778869180-41d0601e046e?w=800',
        tags: [],
        status: "draft",
        is_featured: false
      };
      ...
      console.log('🌐 API URL:', `${API_BASE_URL}/blogs/admin/create`);

      const response = await axios.post(`${API_BASE_URL}/blogs/admin/create`, blogData, { headers });
      
      console.log('✅ Response:', response.data);
      showMessage("Thêm bài viết thành công!");
