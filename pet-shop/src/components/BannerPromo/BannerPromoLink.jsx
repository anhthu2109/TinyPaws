...
// Alternative version using Link components instead of navigate
const BannerPromoLink = () => {
    return (
            ...
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Link 
                        ...
                        className="banner-item relative rounded-xl overflow-hidden h-[200px] sm:h-[220px] md:h-[250px] group block transform hover:scale-[1.02] transition-all duration-300"
...
export default BannerPromoLink;
